    ...
    <header className="bg-blue-600 text-white shadow-lg sticky top-0 z-50">
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6">
          <Link to="/" className="text-sm md:text-base hover:text-blue-100 transition">
            Beranda
          </Link>
          <Link to="/beasiswa" className="text-sm md:text-base hover:text-blue-100 transition">
            Beasiswa
          </Link>
          <Link to="/artikel" className="text-sm md:text-base hover:text-blue-100 transition">
            Artikel
          </Link>
          <Link to="/tentang" className="text-sm md:text-base hover:text-blue-100 transition">
            Tentang
          </Link>
          ...
          {isLoggedIn ? (
            ...
            <>
              <Link
                to="/login"
                className="px-3 md:px-4 py-2 bg-white text-blue-600 rounded hover:bg-blue-50 transition text-sm md:text-base"
              >
                Login
              </Link>
              <Link
                to="/register"
                className="px-3 md:px-4 py-2 bg-blue-700 rounded hover:bg-blue-800 transition text-sm md:text-base"
              >
                Register
              </Link>
            </>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-blue-700 px-4 py-4 space-y-3">
          <Link to="/" className="block text-sm hover:text-blue-100 transition py-2">
            Beranda
          </Link>
          <Link to="/beasiswa" className="block text-sm hover:text-blue-100 transition py-2">
            Beasiswa
          </Link>
          <Link to="/artikel" className="block text-sm hover:text-blue-100 transition py-2">
            Artikel
          </Link>
          <Link to="/tentang" className="block text-sm hover:text-blue-100 transition py-2">
            Tentang
          </Link>
          ...
          {isLoggedIn ? (
            <>
              ...
              <NotificationBell />
              <div className="py-2">
                <p className="font-semibold mb-2 text-sm">👤 {user?.name}</p>
              </div>
              {user?.role === 'admin' && (
                <Link
                  to="/admin/dashboard"
                  className="block text-sm hover:text-blue-100 transition py-2"
                >
                  Admin Dashboard
                </Link>
              )}
              ...
              <button
                ...
                className="block w-full text-left py-2 text-red-300 hover:text-red-200 transition text-sm"
              >
                Logout
              </button>
            </>
            ...
            <>
              ...
              <Link
                to="/login"
                className="block px-4 py-2 bg-white text-blue-600 rounded hover:bg-blue-50 transition text-center text-sm"
              >
                Login
              </Link>
              <Link
                to="/register"
                className="block px-4 py-2 bg-blue-800 rounded hover:bg-blue-900 transition text-center text-sm"
              >
                Register
              </Link>
            </>
